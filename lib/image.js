...
Promise.guard(IMAGE_REQUEST_LIMIT, function(img, imagedir, status /* Optional */) {
	...
	var isTooBig = (img.imageinfo.width > maxRes);
	...
	var doRequest = function(retries) {
		return rrequest({ url: realURL, encoding: null, headers: headers, pool: false, log: log, stream: true }).spread(function(inStream, req) {
